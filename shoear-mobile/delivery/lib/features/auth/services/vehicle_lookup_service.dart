...
///
/// Hardcoded for reliability — the NHTSA vPIC API (the only free option that
/// covers motorcycles) times out consistently from Malaysia due to US-server
/// latency and large payload sizes. The local list is curated for the
/// Malaysian market; the VehiclePicker's "Other (type manually)" escape hatch
/// covers any brand or model not listed here.
