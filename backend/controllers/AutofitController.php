...
//   &swapLR=0|1       (1 swaps Shoe_L/Shoe_R for an unlabeled pair the auto guess got backwards)
//
...
function handleAdminProductAutofit(PDO $pdo, string $id, array $config): void {
  ...
  // Optional admin PAIR triangle total (both feet). Absent/0 -> Snapchat's ~100k default.
  ...
  // Optional admin manual L/R override for an unlabeled pair: swaps which shoe is
  // Shoe_L vs Shoe_R when the auto guess put them on the wrong feet.
